#ifndef __MYRT_SPHERE_H__
#define __MYRT_SPHERE_H__
...
{
public:
    Sphere(point3 pos, double radius) : center(pos), radius(radius) {}
...
inline void Sphere::get_sphere_uv(const point3& p, double& u, double& v) {
